...
def generate_launch_description():
    args = [
        ...
        DeclareLaunchArgument('threshold_filter_max', default_value='200'),
        ...
        DeclareLaunchArgument('config_file_path', default_value=os.path.join(os.path.dirname(__file__), '..', 'config', 'gemini330_series.yaml')),
    ...
    def create_static_tf(context):
        camera_name = LaunchConfiguration('camera_name').perform(context)
        return [
            Node(
                package='tf2_ros',
                executable='static_transform_publisher',
                arguments=['0', '0', '0', '0', '0', '0', '1', 'base_link', f'{camera_name}_link'],
                # arguments=['0', '0', '0', '-0.5', '-0.5', '0.5', '0.5', 'base_link', f'{camera_name}_link'],
                output='log',
            ),
        ]
    ...
    return LaunchDescription(
        args + [
            ...
            Node(
                ...
                executable='gemini_grid_node',
                name='gemini_grid_node',
                parameters=[{
                    'fov_axis_deg':  43.0,
                    'min_range_m':    0.1,
                    'max_range_m':    4.0,
                    'input_topic':  '/camera/depth/points',
                    'output_topic': '/tof/gemini/points',
